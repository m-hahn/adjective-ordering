...
var     adjectives = _.shuffle(["rofky", "glab"]);
...
function makeStimsContext() {
     ...
     text = "The more spikes, the better. My favorite one is this..."
     relevant_adjective = adjectives[0]
     alien = aliens[0];
     color = _.sample(colors);
     ship = ships[1]
     addStimulus(relevant_adjective, relevant_adjective, adjectives[1], text, ship, alien, color, 5)
     ...
     relevant_adjective = color
     ship = ships[1]
     addStimulus(relevant_adjective, relevant_adjective, adjectives[1], text, ship, alien, color, _.sample([1,2,3,4]))
     ...
     color = _.sample(colors);
     ship = ships[1]
     addStimulus(relevant_adjective, relevant_adjective, color, text, ship, alien, color, _.sample([1,2,3,4,5]))
     ...
     color = _.sample(colors);
     ship = ships[1]
     addStimulus(relevant_adjective, color, adjectives[1], text, ship, alien, color, _.sample([1,2,3,4,5]))
     ...
     color = _.sample(colors);
     ship = ships[1]
     addStimulus("NONE", color, adjectives[1], text, ship, alien, color, _.sample([1,2,3,4,5]))
