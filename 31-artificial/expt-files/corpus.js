...
function makeStimsContext() {
     ...
     text = "Wow, so "+(ships[1].indexOf("few") > -1 ? "few" : "many")+" fins &#8210; I like this..."
     ...
     text = "The "+(ships[1].indexOf("few") > -1 ? "fewer" : "more")+" spikes, the better. My favorite one is this..."
     relevant_adjective = adjectives[1]
     alien = aliens[0];
     color = _.sample(colors);
     ship = ships[1]
     ...
     text = "Ugh, too "+(ships[1].indexOf("few") > -1 ? "few" : "many")+" fins &#8210; I hate flying this..."
     relevant_adjective = adjectives[1]
     alien = aliens[1];
     color = _.sample(colors);
     ship = ships[1] 
     ...
     text = "I really don't like ships with "+(ships[1].indexOf("few") > -1 ? "few" : "many")+" spikes, like this..."
     relevant_adjective = adjectives[1]
     alien = aliens[1];
     color = _.sample(colors);
     ship = ships[1]
