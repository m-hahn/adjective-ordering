...
// first pilot: 2/3 are redundant (correlation 0.95, also correlates with subjectivity) 
      ...
      for(var i in questions) {
         ...
         questionTable += '<tr> <td width="50%" style="font-size:17px;text-align:left;"> <span class="question_'+index+'">{{}}</span> </td><td>    <table id="multi_slider_table_dialogue_1" class="slider_table">      <tr><td><span class="low">No</span></td><td>      <div id="slider0_dialogue_'+index+'" class="slider"></div>      </td><td><span class="high">Yes</span></td></tr>    </table></td></tr>'
      }
