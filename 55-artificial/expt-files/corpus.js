...
function makeStimsContext() {
     ...
     text = "I like ships of this type. My favorite one is this..."
     relevant_adjective = adjectives[1]
     alien = aliens[0];
     color = _.sample(colors);
     ship = ships[1]
     ...
     if(false) {
       text = "Humans think all of our ships look like this..."
     } else {
       text = "Humans think all of our ships look like this..."
     }
     alien = _.sample(aliens);
     ...
     if(false) {
       text = "For long distances, I use this..."
     } else {
       text = "For long distances, I use this..."
     }
     alien = _.sample(aliens);
