...
function makeStimsContext() {
     ...
     text = "Wow, "+(ships[1].indexOf("few") > -1 ? "no" : "so many")+" fins &#8210; I like this..."
     ...
     text = "Ugh, "+(ships[1].indexOf("few") > -1 ? "no" : "so many")+" fins &#8210; I hate flying this..."
     relevant_adjective = adjectives[1]
     alien = aliens[1];
     color = _.sample(colors);
     ship = ships[1] 
     ...
     text = "I really don't like ships "+(ships[1].indexOf("few") > -1 ? "without" : "with")+" spikes, like this..."
     relevant_adjective = adjectives[1]
     alien = aliens[1];
     color = _.sample(colors);
     ship = ships[1]
