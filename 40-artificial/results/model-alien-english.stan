...
responseAlienFirst[n] ~ normal( alpha +for_workerid[1,workeridForN] + for_adjective1[1,adjective1ForN] + for_adjective2[1,adjective2ForN] + containsSubjectiveAdjective[n] * (beta1 + for_adjective1[2,adjective1ForN] + for_workerid[2,workeridForN] + for_adjective2[2,adjective2ForN]) , sigma_e);
 }
}
